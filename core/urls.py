...
urlpatterns = [
    ...
    path('orden/eliminar/<int:orden_id>/', views.eliminar_orden, name='eliminar_orden'), # <--- NUEVA
    
    # Clientes y Vehículos
    path('cliente/crear/', views.crear_cliente, name='crear_cliente'),
    path('cliente/eliminar/<int:cliente_id>/', views.eliminar_cliente, name='eliminar_cliente'), # <--- NUEVA
    path('vehiculo/crear/', views.crear_vehiculo, name='crear_vehiculo'),
    path('vehiculo/eliminar/<int:vehiculo_id>/', views.eliminar_vehiculo, name='eliminar_vehiculo'), # <--- NUEVA
